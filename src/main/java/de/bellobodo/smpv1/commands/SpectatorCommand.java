...
public class SpectatorCommand implements CommandExecutor {
    ...
    public SpectatorCommand(SMPV1 smpv1) {
        this.smpv1 = smpv1;
    }

    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!sender.hasPermission("smpv1.command.spectator")) {
    ...
    public void sendUsage(CommandSender sender) {
        sender.sendMessage(smpv1.getPrefix() + ChatColor.BLUE + "Verwende: " + ChatColor.GRAY + "/spectator (add/remove) <Spielername>" );
    }
}
